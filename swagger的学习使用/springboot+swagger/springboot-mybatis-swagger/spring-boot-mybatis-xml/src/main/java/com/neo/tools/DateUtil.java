...
//    }
    ...
    *//**
    ...
    public static long betweenDays(Date beginDate, Date endDate) {
        LocalDate localBeginDate = dateToLocalDate(beginDate);
        LocalDate localEndDate = dateToLocalDate(endDate);
        long value = Math.abs(localBeginDate.toEpochDay() - localEndDate.toEpochDay());
        return value;
    }
...
/*    public static Date getCurrentQuarterStartTime() {
        ...
        try {
            ...
            now = parseDateTime(formatDate(c.getTime()) + " 00:00:00");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return now;
...
/*    public static Date getCurrentQuarterEndTime() {
        ...
        try {
            ...
            now = parseDateTime(formatDate(c.getTime()) + " 23:59:59");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return now;
